...
const lightTheme = {
  backgroundColor: "#fff",
  color: "#000",
  containerBackgroundColor: "#F0ECE3",
};
const darkTheme = {
  backgroundColor: "#000",
  color: "#fff",
...
const projects = [
  {
    ...
    learning:
      "By doing this project, I have learn Reactjs, global state management with Redux( Redux Toolkit), handle asynchronous requests in redux toolkit, permission in a web app, use firebase and firestore for authentication and saving user data.",
  ...
  },
  {
    ...
    learning:
      "In this project, I learn Reactjs, how to fetch data from API( the movieDb), and use TailwindCss library for stying web app",
  ...
  },
  {
    ...
    learning:
      "In project, I learn HTML, CSS and JS, how to use JS for interacting with DOM",
  ...
  },
  {
    ...
    image: landingpage,
    learning:
      "In project, I learn HTML, SASS and JS, how to  use JS for interacting with DOM",
